...
public class VitalDAOImp extends AbstractDAO implements TemplateDAO<Vital> {
    ...
    public boolean addVitalStaff(Vital p,Staff staff) {
	 boolean rest=true;
	    try {
	      openConnection();
	      ...
	      preparedStatement = connection
	              .prepareStatement("INSERT INTO staff_records_vital (employee_id,last_name, DOB, temperature, blood_pressure_systolic,blood_pressure_diastolic) values (?,?, ?, ?, ?,?)");
